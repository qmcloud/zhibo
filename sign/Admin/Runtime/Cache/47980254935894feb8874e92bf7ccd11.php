...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        verifyURL= "<?php echo U('Login/verify','','');?>"
		</script>
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code"/> <img src="<?php echo U('Login/verify');?>" id="code"/> <a href="javascript:void(change_code(this));">看不清</a>
					</td>
				</tr>
				<tr>
