/* 代码整理：uu http://www.912uu.tv */

//右键菜单
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("网页特效下载:<br /><a href=\"http://www.912uu.tv/\" title=\"uu\">uu</a>    <a href=\"http://www.lanrenzhijia.com\" title=\"首页\">首页</a>",10000);
}
});
