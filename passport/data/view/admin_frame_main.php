...
<div class="container">
	...
	<h3>系统信息</h3>
	<ul class="memlist fixwidth">
		<li><em>UCenter 程序版本:</em>UCenter <?php echo UC_SERVER_VERSION;?> Release <?php echo UC_SERVER_RELEASE;?> <a href="http://www.discuz.net/forumdisplay.php?fid=151" target="_blank">查看最新版本</a> 
